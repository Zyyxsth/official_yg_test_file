...
void diablo_imu_publisher::imu_pub_init(void)
{
    ...
    timer_ = this->node_ptr.createTimer(ros::Duration(0.02),std::bind(&diablo_imu_publisher::lazyPublisher, this));
...
diablo_imu_publisher::diablo_imu_publisher(ros::NodeHandle& node,DIABLO::OSDK::Vehicle* vehicle)
:node_ptr(node)
{
